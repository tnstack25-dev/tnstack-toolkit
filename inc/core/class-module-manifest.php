...
final class TNStack_Module_Manifest {
	...
	public static function definitions() {
		...
		self::$definitions = array(
			'performance'            => self::entry( 'core', self::CONFIG_MODULES, true, 'subsystem', 'inc/core/performance/init.php', __( 'Tối ưu & Bảo mật', 'tnstack-toolkit' ), __( 'Cache, WAF, giám sát mã độc và hardening.', 'tnstack-toolkit' ), 'shield-alt', 'core' ),
