...
final class TNStack_Module_Manifest {
	...
	public static function definitions() {
		...
		self::$definitions = array(
			...
			'floating-contact'       => self::entry( 'content', self::CONFIG_MODULES, false, 'simple', 'inc/modules/floating-contact.php', __( 'Floating Contact', 'tnstack-toolkit' ), __( 'Nút Zalo, phone, WhatsApp, Messenger.', 'tnstack-toolkit' ), 'phone', 'content', 'tnstack_floating_contact_render_admin' ),
